...
typedef enum
{
    ...
    /** Node is advertiser */
    APP_LIB_SETTINGS_ROLE_ADVERTISER = 4,
} app_lib_settings_base_role_e;

/**
 * @brief Role flag bits
 *
 * Role flag bits are used by the @ref
 * app_lib_settings_create_role() utility function to create
 * a role value.
 */
typedef enum
{
    /** Enable CSMA-CA (CB-MAC/low-latency) operation for this node */
 ...
 *
 * The node role value which is a combination of a @ref
 * app_lib_settings_base_role_e "base role" and @ref
 * app_lib_settings_flag_role_e "flags bits". Utility function @ref
 ...
 * @brief Create a role
 *
 * A utility function to create a role value from a @ref
 * app_lib_settings_base_role_e "base role" and @ref
 * app_lib_settings_flag_role_e "flags bits".
 *
 * The role value can be used to set a node role
...
/**
 * @brief Get base role from full role
 *
...
/**
 * @brief Get flags from full role
 *
 ...
 * @brief  Set node role
 *
 * Utility function @ref app_lib_settings_create_role() can be used to create a
