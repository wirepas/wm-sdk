...
LDSCRIPT := v5_0_updater/linker/$(MCU)$(MCU_SUB)/gcc_bl_updater_$(MCU)$(MCU_SUB)$(MCU_MEM_VAR).ld
...
#
SRCS += v5_0_updater/drivers/$(MCU)$(MCU_SUB)/flash.c
SRCS += v5_0_updater/main.c

CFLAGS += -Iv5_0_updater/drivers/
CFLAGS += -Imcu/$(MCU)/
