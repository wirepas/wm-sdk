...
#define BOARD_GPIO_PIN_LIST            {2,  /* P0.02 */\
                                        ...
                                        28, /* P0.28. usart rx pin */\
                                        26, /* P0.26. usart cts pin */\
                                        27, /* P0.27. usart rts pin */\
...
#define BOARD_GPIO_ID_USART_TX          6  // mapped to pin P0.29
#define BOARD_GPIO_ID_USART_RX          7  // mapped to pin P0.28
#define BOARD_GPIO_ID_USART_CTS         8  // mapped to pin P0.26
#define BOARD_GPIO_ID_USART_RTS         9  // mapped to pin P0.27
#define BOARD_GPIO_ID_UART_IRQ          10 // mapped to pin P0.11
