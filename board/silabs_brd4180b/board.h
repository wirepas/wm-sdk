...
//#define BOARD_LED_PIN_LIST {{GPIO_PORTB, 0}, {GPIO_PORTB, 1}} // brd4180a
#define BOARD_LED_PIN_LIST {{GPIO_PORTD, 2}, {GPIO_PORTD, 3}} // brd4180b

// Active high polarity for LEDs
#define BOARD_LED_ACTIVE_LOW false

// List of ext. ints, GPIO ports and pins for buttons on the board: BTN0
//#define BOARD_BUTTON_PIN_LIST           {{0, GPIO_PORTD, 2},{2, GPIO_PORTD, 3}} // brd4180a
#define BOARD_BUTTON_PIN_LIST           {{0, GPIO_PORTB, 0},{2, GPIO_PORTB, 1}} // brd4180b
