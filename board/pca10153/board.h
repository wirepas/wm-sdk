...
#define HAL_DBG_MCU_PIN                 0      // P0.00  gpio/LED-1
#define HAL_DBG_TASK_MGMT_PIN           1      // P0.01  gpio/LED-2
#define HAL_DBG_TASK_ROUTE_PIN          2      // P0.02  gpio
#define HAL_DBG_TASK_WAPS_PIN           3      // P0.03  gpio
#define HAL_DBG_TASK_MAC_PIN            4      // P0.04  gpio/LED-3
#define HAL_DBG_IRQ_USART_PIN           5      // P0.05  gpio/LED-4
#define HAL_DBG_RADIO_CRC_PIN           6      // P0.06  gpio
#define HAL_DBG_IRQ_RTC_PIN             7      // P0.07  gpio
#define HAL_DBG_IRQ_RADIO_PIN           8      // P0.08  gpio/BUTTON-1
#define HAL_DBG_RADIO_TX_PIN            9      // P0.09  gpio/BUTTON-2
#define HAL_DBG_RADIO_RX_PIN            30     // P0.30  gpio/I2C_SDA
#define HAL_DBG_ASSERT_PIN              31     // P0.31  gpio/I2C_SCL
