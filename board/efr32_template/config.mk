...
# - <code>pxxxf512</code> For 512 kB flash memory variant (xg12/xg13)
# - <code>xxxxf512</code> For 512 kB flash memory variant (xg22)
# - <code>pxxxf1024</code> For 1024 kB flash memory variant (xg12/xg13)
