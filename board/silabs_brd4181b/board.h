...
#define BOARD_GPIO_ID_USART_TX          4  // mapped to pin PA05
#define BOARD_GPIO_ID_USART_RX          5  // mapped to pin PA06
#define BOARD_GPIO_ID_USART_VCOM        6  // mapped to pin PD04
