...
// Skyworks RFX2411 PA/LNA antenna front end chip pins
#define PA_LNA_RX_EN_PIN                38
#define PA_LNA_TX_EN_PIN                37
#define PA_LNA_MODE_PIN                 36
#define PA_LNA_SW_ANT_PIN               34
