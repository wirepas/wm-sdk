...
typedef enum
{
    POSLIB_BLE_BEACON_OFF = 0,         // Never used
    POSLIB_BLE_BEACON_ON,              // Always used
    POSLIB_BLE_BEACON_ON_WHEN_OFFLINE, // Used when offline
} poslib_ble_setup_e;
...
/**
 * @brief   Allows to start/stop the configured BLE beacons. If BLE beacons are
 *          not configured and start is requested an error will be returned.
 * @param   pos_ble_mode type of poslib_ble_mode_e
 * @return  See \ref poslib_ret_e
 */
