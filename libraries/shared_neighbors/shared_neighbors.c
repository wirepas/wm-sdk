...
#ifdef DEBUG_SHARED_STATE_LOG_MAX_LEVEL
#define DEBUG_LOG_MAX_LEVEL DEBUG_SHARED_STATE_LOG_MAX_LEVEL
#else
                      ...
                      uint16_t * cb_id)
{
    ...
    for (uint8_t i = 0; i < SHARED_NEIGHBORS_MAX_CB; i++)
    {
        ...
        {
            /* One callback found */
            m_neighbor_scan[i].cb_scanned_neighbor = cb_scanned_neighbor;
            /* Set the id */
            *cb_id = i;
            res = APP_RES_OK;
            break;
