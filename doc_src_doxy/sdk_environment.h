...
@page installation_of_sdk_environment Installation of SDK Environment

This page contains following sections:
- @subpage windows_installation
- @subpage linux_installation

@page windows_installation  Windows installation using WSL
...
@page wsl_compiler Compiler installation
...
@page wsl_misc Miscellaneous installation
...
@page linux_installation Installation on Ubuntu Linux

For Ubuntu-based variants, follow guideline used in @ref windows_installation
"Windows installation using WSL".

@page checking_the_installation_validity Checking the installation validity
...
@page flashing_guideline Flashing devices
...
@page flashing_nordic_nrf52_devices Flashing Nordic nRF52 devices
...
@page flashing_silabs_devices Flashing Silicon Labs Devices
...
@page nordic_nrf52832_nrf52840 Resources on Nordic nRF52832 & nRF52840
...
@page flash_memory_nrf52 Flash Memory available for application on nRF52
...
@page ram_memory_nrf52 RAM Memory available for application on nRF52
...
@page peripherals_accessible_by_stack_only Peripherals accessible by stack only
...
@page peripherals_shared_between_the_stack_and_the_application Peripherals Shared between the stack and the application
...
@page peripherals_available_for_the_application Peripherals available for the application

All the other peripherals not listed above are free to be used by the application.

@page efr32xg12 Resources on EFR32xG12
...
@page flash_memory_efr32 Flash Memory available for application on EFR32
...
@page ram_memory_efr32 RAM Memory available for application on EFR32
...
@page peripherals_accessible_by_stack_only2 Peripherals accessible by stack only
...
@page peripherals_shared_between_the_stack_and_the_application2 Peripherals Shared between the stack and the application
...
@page peripherals_available_for_the_application2 Peripherals available for the application
