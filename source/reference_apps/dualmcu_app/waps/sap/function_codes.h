...
typedef enum
{
    ...
    /* DEPRECATED (OLD LEGACY APP CONFIG) */
    DEPRECATED_APPCFG_WR = 0x08,
    DEPRECATED_APPCFG_WR_CNF = 0x88,
    DEPRECATED_APPCFG_RD = 0x09,
    DEPRECATED_APPCFG_RD_CNF = 0x89,
    DEPRECATED_APPCFG_IND = 0x0A,
    DEPRECATED_APPCFG_IND_RSP = 0x8A,
    ...
    WAPS_FUNC_MSAP_REMOTE_UPDATE_REQ = 0x1E,
    WAPS_FUNC_MSAP_REMOTE_UPDATE_CNF = 0x9E,
    ...
    /* TSAP-TEST_MODE_ENTER */
    WAPS_FUNC_TSAP_TEST_MODE_ENTER_REQ  = 0x43,
    WAPS_FUNC_TSAP_TEST_MODE_ENTER_CNF  = 0xC3,
    /* TSAP-TEST_MODE_EXIT */
    WAPS_FUNC_TSAP_TEST_MODE_EXIT_REQ   = 0x44,
    WAPS_FUNC_TSAP_TEST_MODE_EXIT_CNF   = 0xC4,
    /* TSAP-RADIO_CHANNEL */
    WAPS_FUNC_TSAP_RADIO_CHANNEL_REQ    = 0x45,
    WAPS_FUNC_TSAP_RADIO_CHANNEL_CNF    = 0xC5,
    /* TSAP-RADIO_TX_POWER */
    WAPS_FUNC_TSAP_RADIO_TX_POWER_REQ   = 0x46,
    WAPS_FUNC_TSAP_RADIO_TX_POWER_CNF   = 0xC6,
    /* TSAP-RADIO_DATA_TX */
    WAPS_FUNC_TSAP_RADIO_DATA_TX_REQ    = 0x47,
    WAPS_FUNC_TSAP_RADIO_DATA_TX_CNF    = 0xC7,
    /* TSAP-RADIO_DATA_RX */
    WAPS_FUNC_TSAP_RADIO_DATA_RX_REQ    = 0x48,
    WAPS_FUNC_TSAP_RADIO_DATA_RX_CNF    = 0xC8,
    WAPS_FUNC_TSAP_RADIO_DATA_RX_IND    = 0x49,
    WAPS_FUNC_TSAP_RADIO_DATA_RX_RSP    = 0xC9,
    /* TSAP-RADIO_GET_MAX_DATA_SIZE */
    WAPS_FUNC_TSAP_RADIO_GET_MAX_DATA_SIZE_REQ  = 0x4A,
    WAPS_FUNC_TSAP_RADIO_GET_MAX_DATA_SIZE_CNF  = 0xCA,
    /* TSAP-RADIO_DATA_READ */
    WAPS_FUNC_TSAP_RADIO_DATA_READ_REQ  = 0x4B,
    WAPS_FUNC_TSAP_RADIO_DATA_READ_CNF  = 0xCB,
    ...
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_WRITE_REQ = 0x4F,
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_WRITE_CNF = 0xCF,
    /* MSAP-MAX_QUEUE_TIME_READ REQ */
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_READ_REQ = 0x50,
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_READ_CNF = 0xD0,

    /* TSAP-RADIO_TEST_SIGNAL_TX REQ */
    WAPS_FUNC_TSAP_RADIO_TEST_SIGNAL_TX_REQ    = 0x51,
    WAPS_FUNC_TSAP_RADIO_TEST_SIGNAL_TX_CNF    = 0xD1,
    ...
    /* DSAP-DIAGNOSTICS_DATA_RX */
    WAPS_FUNC_DSAP_RESERVED_LEGACY = 0x7E,
    WAPS_FUNC_DSAP_RESERVED_LEGACY_RSP = 0xFE,
    /* Debug prints */
    WAPS_FUNC_DEBUG = 0x7F,
} waps_func_e;
...
{                                                   \
    ...
    WAPS_FUNC_MSAP_REMOTE_UPDATE_REQ,               \
    ...
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_WRITE_REQ, \
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_READ_REQ,  \
...
#define TSAP_REQUESTS                   \
{                                       \
    WAPS_FUNC_TSAP_TEST_MODE_ENTER_REQ, \
    WAPS_FUNC_TSAP_TEST_MODE_EXIT_REQ,  \
    WAPS_FUNC_TSAP_RADIO_CHANNEL_REQ,   \
    WAPS_FUNC_TSAP_RADIO_TX_POWER_REQ,  \
    WAPS_FUNC_TSAP_RADIO_DATA_TX_REQ,   \
    WAPS_FUNC_TSAP_RADIO_DATA_RX_REQ,   \
    WAPS_FUNC_TSAP_RADIO_GET_MAX_DATA_SIZE_REQ, \
    WAPS_FUNC_TSAP_RADIO_DATA_READ_REQ, \
    WAPS_FUNC_TSAP_RADIO_TEST_SIGNAL_TX_REQ, \
}
...
{                                                   \
    ...
    WAPS_FUNC_TSAP_TEST_MODE_ENTER_CNF,             \
    WAPS_FUNC_TSAP_TEST_MODE_EXIT_CNF,              \
    WAPS_FUNC_TSAP_RADIO_CHANNEL_CNF,               \
    WAPS_FUNC_TSAP_RADIO_TX_POWER_CNF,              \
    WAPS_FUNC_TSAP_RADIO_DATA_TX_CNF,               \
    WAPS_FUNC_TSAP_RADIO_DATA_RX_CNF,               \
    WAPS_FUNC_TSAP_RADIO_GET_MAX_DATA_SIZE_CNF,     \
    WAPS_FUNC_TSAP_RADIO_DATA_READ_CNF,             \
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_WRITE_CNF, \
    WAPS_FUNC_MSAP_MAX_MSG_QUEUEING_TIME_READ_CNF,  \
    WAPS_FUNC_TSAP_RADIO_TEST_SIGNAL_TX_CNF,        \
    WAPS_FUNC_MSAP_SCRATCHPAD_TARGET_READ_REQ,      \
    WAPS_FUNC_MSAP_SCRATCHPAD_TARGET_WRITE_REQ      \
}
...
{                                                   \
    ...
    WAPS_FUNC_TSAP_RADIO_DATA_RX_RSP,               \
