...
static const uint8_t m_attr_size_lut[] =
{
    ...
    CSAP_ATTR_GENCFG_MAX_SIZE_SIZE,
                                   ...
                                   uint8_t attr_size)
{
    ...
    switch (attr_id)
    {
        ...
        case CSAP_ATTR_NETWORK_BEACONINTERVAL:
            result = lib_settings->getMacNetworkbeaconinterval(&tmp);
            break;
#endif
        default:
...
#ifdef WITH_BEACONINTERVAL
        case CSAP_ATTR_NETWORK_BEACONINTERVAL:
            result = lib_settings->setMacNetworkbeaconinterval(tmp);
            break;
#endif
        default:
            // Unsupported attribute
