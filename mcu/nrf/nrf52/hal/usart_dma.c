...
static void set_flow_control(bool hw)
{
    if (hw)
    {
        ...
        NRF_UARTE0->CONFIG = UART_CONFIG_HWFC_Enabled << UART_CONFIG_HWFC_Pos;
    }
    else
    {
        NRF_UARTE0->PSEL.RTS = 0xFFFFFFFF;
...
static bool set_baud(uint32_t baudrate)
{
    ...
    case 125000:
        ...
        break;
    case 250000:
        NRF_UARTE0->BAUDRATE = (uint32_t)UART_BAUDRATE_BAUDRATE_Baud250000;
        break;
    case 460800:
        NRF_UARTE0->BAUDRATE = (uint32_t)UART_BAUDRATE_BAUDRATE_Baud460800;
        break;
    case 1000000:
