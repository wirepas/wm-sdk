/**************************************************************************//**
 * @file
 * @brief EFR32MG22 SYSCFG register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32MG22_SYSCFG_H
#define EFR32MG22_SYSCFG_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MG22_SYSCFG SYSCFG
 * @{
 * @brief EFR32MG22 SYSCFG Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  uint32_t       RESERVED6[122U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED17[122U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED28[122U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED39[122U];              /**< Reserved for future use                            */
...
/** @} End of group EFR32MG22_SYSCFG */

/**************************************************************************//**
 * @addtogroup EFR32MG22_SYSCFG
 * @{
 * @defgroup EFR32MG22_SYSCFG_BitFields SYSCFG Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG22_SYSCFG_BitFields */
/** @} End of group EFR32MG22_SYSCFG */
/**************************************************************************//**
 * @defgroup EFR32MG22_SYSCFG_CFGNS SYSCFG_CFGNS
 * @{
 * @brief EFR32MG22 SYSCFG_CFGNS Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32MG22_SYSCFG_CFGNS */

/**************************************************************************//**
 * @addtogroup EFR32MG22_SYSCFG_CFGNS
 * @{
 * @defgroup EFR32MG22_SYSCFG_CFGNS_BitFields SYSCFG_CFGNS Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG22_SYSCFG_CFGNS_BitFields */
/** @} End of group EFR32MG22_SYSCFG_CFGNS */
/** @} End of group Parts */

#endif /* EFR32MG22_SYSCFG_H */
